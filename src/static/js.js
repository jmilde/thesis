    ...
    const generate_similar = img => () => {
        $.ajax({
            ...
            data    : JSON.stringify({"img"   :img,
                                      "text"  :$('#text')[0].value,
                                      "color_1":$('#color_1')[0].value,
                                      "color_2":$('#color_2')[0].value,
                                      "color_3":$('#color_3')[0].value,
                                      "color_4":$('#color_4')[0].value,
                                      "color_5":$('#color_5')[0].value,
                                      "value_1":$('#value_1')[0].value,
                                      "value_2":$('#value_2')[0].value,
                                      "value_3":$('#value_3')[0].value,
                                      "value_4":$('#value_4')[0].value,
                                      "value_5":$('#value_5')[0].value,
                                     }),
